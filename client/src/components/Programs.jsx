  ...
  return (
    ...
    <div className="w-11/12 mx-auto my-20 gap-10 flex items-center justify-between flex-wrap lg:flex-nowrap">
      <div className="relative flex-basis-31 w-full lg:w-auto mb-5 lg:mb-0">
        <img src='https://firebasestorage.googleapis.com/v0/b/my-first-project-6eebf.appspot.com/o/college.jpg?alt=media&token=2ad202d7-85af-4602-8d8f-11a86d69847c' alt="" className="w-full rounded-lg" />
